...
const SmallCalenderEvent = ({ arg }) => {
    ...
    return (
        <div className={"calender__event calender__small"}
                    style={{
                    ...
                    {/* Header */}
                    <div 
                    className={"small_calenderHeader"}
                    style={{
                        color: `${"#000"}`,
                    ...
                    <div style={{ padding: "0px 5px", fontWeight: "bold" }}>
                        { event.title }
                    </div>
...
export default SmallCalenderEvent